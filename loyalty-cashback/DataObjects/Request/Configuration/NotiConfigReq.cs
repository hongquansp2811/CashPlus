...
{
    public class NotiConfigReq :  PagingRequest
    {
        ...
        public string? MC_Payment_Refund { get; set; } //Hoàn tiền Merchant
        ...
        public string? MC_Payment_SMSPointSave { get; set; } //Thanh toán - SMS điểm tiêu dùng Merchant
        public string? MC_Payment_SMSPointUse { get; set; } //Thanh toán - SMS điểm tích lũy Merchant
