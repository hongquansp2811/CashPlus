...
{
    [Route("api/store/portalStore")]
    //[Authorize(Policy = "WebPartnerUser")]
    [ApiController]
    public class PortalStoreController : ControllerBase
    {
        ...
        public PortalStoreController(IConfiguration configuration, IOtherListType otherListType, ILoggingHelpers logging, LOYALTYContext context, IEmailSender emailSender, ICommonFunction commonFunction)
        {
