...
namespace LOYALTY.Controllers
{
    ...
    public class PortalController : ControllerBase
    {
        ...
        public PortalController(IConfiguration configuration, IOtherListType otherListType, ILoggingHelpers logging, LOYALTYContext context, IEmailSender emailSender, ICommonFunction commonFunction)
        {
