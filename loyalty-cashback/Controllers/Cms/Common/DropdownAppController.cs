...
{
    [Route("api/app/dropdownApp")]
    [Authorize(Policy = "AppUser")]
    [ApiController]
    public class DropdownAppController : ControllerBase
    {
        ...
        public DropdownAppController(IConfiguration configuration, IOtherListType otherListType, ILoggingHelpers logging, LOYALTYContext context)
        {
