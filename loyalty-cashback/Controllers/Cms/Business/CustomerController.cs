...
namespace LOYALTY.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        private static string functions = "cms_authen_customer";
        public CustomerController(IConfiguration configuration, ICustomer Customer, ILoggingHelpers logging, LOYALTYContext context)
        {
        ...
        [Route("list")]
        [HttpPost]
        public JsonResult GetList(CustomerRequest request)
        {
            ...
            APIResponse data = _Customer.getList(request);
        ...
        public JsonResult GetDetail(Guid id)
        {
            ...
            APIResponse data = _Customer.getDetail(id);
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/customer/" + id,
                actions = "Chi tiết Khách hàng",
                application = "WEB ADMIN",
        ...
        public JsonResult Update(CustomerRequest request)
        {
            ...
            APIResponse data = _Customer.update(request, username.Value);
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/customer/update",
                actions = "Cập nhật Khách hàng",
                application = "WEB ADMIN",
        ...
        public JsonResult changeStatus(DeleteGuidRequest req)
        {
            ...
            APIResponse data = _Customer.changeStatus(req);
            // Ghi log
            if (data.code == "200")
            {
                var remoteIP = Request.HttpContext.Connection.RemoteIpAddress;
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/customer/changeStatus",
        ...
        public JsonResult changePassword(PasswordRequest req)
        {
            ...
            APIResponse data = _Customer.changePassword(req);
            // Ghi log
            if (data.code == "200")
            {
                var remoteIP = Request.HttpContext.Connection.RemoteIpAddress;
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/customer/changePassword",
                    actions = "Đổi mật khẩu khách hàng",
                    application = "WEB ADMIN",
                    content = "Đổi mật khẩu khách hàng",
                    functions = "Nghiệp vụ",
                    is_login = false,
                    result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                    user_created = username.Value,
        ...
        public JsonResult getListAccumulatePointOrder(AccumulatePointOrderRequest req)
        {
            ...
            APIResponse data = _Customer.getListAccumulatePointOrder(req);
            // Ghi log
            if (data.code == "200")
            {
                var remoteIP = Request.HttpContext.Connection.RemoteIpAddress;
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/customer/getListAccumulatePointOrder",
        ...
        public JsonResult getListChangePointOrder(ChangePointOrderRequest req)
        {
            ...
            APIResponse data = _Customer.getListChangePointOrder(req);
            // Ghi log
            if (data.code == "200")
            {
                var remoteIP = Request.HttpContext.Connection.RemoteIpAddress;
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/customer/getListChangePointOrder",
        ...
        public JsonResult getListPartnerOrder(PartnerOrderRequest req)
        {
            ...
            APIResponse data = _Customer.getListPartnerOrder(req);
            // Ghi log
            if (data.code == "200")
            {
                var remoteIP = Request.HttpContext.Connection.RemoteIpAddress;
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/customer/getListPartnerOrder",
        ...
        public JsonResult getListAccumulatePointOrderRating(AccumulatePointOrderRatingRequest req)
        {
            ...
            APIResponse data = _Customer.getListAccumulatePointOrderRating(req);
            // Ghi log
            if (data.code == "200")
            {
                var remoteIP = Request.HttpContext.Connection.RemoteIpAddress;
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/customer/getListAccumulatePointOrderRating",
        ...
        [Route("getListTeam")]
        [HttpPost]
        public JsonResult getListTeam(CustomerRequest req)
        {
            var username = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Name)).FirstOrDefault();
            var list_permission = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Role)).Select(p => p.Value).FirstOrDefault();
            ...
            APIResponse data = _Customer.getListTeam(req);
            // Ghi log
            if (data.code == "200")
            {
                var remoteIP = Request.HttpContext.Connection.RemoteIpAddress;
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/customer/getListTeam",
