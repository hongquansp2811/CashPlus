...
namespace LOYALTY.Controllers
{
    ...
    [Authorize]
    [ApiController]
    public class ExportPartnerController : ControllerBase
    {
        ...
        public ExportPartnerController(IConfiguration configuration, ILoggingHelpers logging, LOYALTYContext context, ICommonFunction commonFunction)
        {
        ...
        [Route("order")]
        [HttpPost]
        public ActionResult ExportPartnerOrder(PartnerOrderRequest request)
        {
            ...
            str.Append("<td><b><font face=Arial Narrow size=3>Giá trị đơn hàng</font></b></td>");
            ...
            for (int i = 0; i < dataResult.Count; i++)
            {
                ...
                str.Append("<td><font face=Arial Narrow size=" + "14px" + ">" + dataResult[i].order_code + "</font></td>");
                str.Append("<td><font face=Arial Narrow size=" + "14px" + ">" + dataResult[i].trans_date + "</font></td>");
                str.Append("<td style='font-family: Arial Narrow; font-size: 14px; mso-number-format:\\@;'>" + dataResult[i].customer_phone + "</font></td>");
                str.Append("<td><font face=Arial Narrow size=" + "14px" + ">" + ReturnMoney((decimal)dataResult[i].total_amount) + "</font></td>");
        ...
        [Route("team")]
        [HttpPost]
        public ActionResult ExportTeam(PartnerRequest request)
        {
            // Default page_no, page_size
            //if (request.page_size < 1)
            //{
            ...
            for (int i = 0; i < dataResult.Count; i++)
            {
                ...
                str.Append("<td><font face=Arial Narrow size=" + "14px" + ">" + ReturnMoney((decimal)dataResult[i].count_person) + "</font></td>");
                str.Append("</tr>");
            }
            str.Append("</table></body></html>");
