...
namespace LOYALTY.Controllers
{
    ...
    public class NotificationTypeController : ControllerBase
    {
        ...
        private readonly INotificationType _app;
        private readonly ILoggingHelpers _logging;
        private static  string functions = "cms_masterdata_notificationtype";
        public NotificationTypeController(IConfiguration configuration, INotificationType app, ILoggingHelpers logging)
        {
        ...
        [Route("list")]
        [HttpPost]
        public JsonResult GetList(NotificationTypeRequest request)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                ...
                is_call_api = true,
                api_name = "api/notificationtype/list",
        ...
        public JsonResult GetDetail(Guid id)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/notificationtype/" + id,
                actions = "Chi tiết Loại thông báo",
                application = "WEB ADMIN",
                content = "Chi tiết Loại thông báo",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        [Route("create")]
        [HttpPost]
        public JsonResult Create(NotificationTypeRequest request)
        {
            var username = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Name)).FirstOrDefault();
                        var list_permission = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Role)).Select(p => p.Value).FirstOrDefault();
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/notificationtype/create",
                actions = "Tạo mới Loại thông báo",
                application = "WEB ADMIN",
                content = "Tạo mới Loại thông báo",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        [Route("update")]
        [HttpPost]
        public JsonResult Update(NotificationTypeRequest request)
        {
            var username = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Name)).FirstOrDefault();
                        var list_permission = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Role)).Select(p => p.Value).FirstOrDefault();
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/notificationtype/update",
                actions = "Cập nhật Loại thông báo",
                application = "WEB ADMIN",
                content = "Cập nhật Loại thông báo",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        public JsonResult Delete(DeleteGuidRequest req)
        {
            ...
            if (data.code == "200")
            {
                ...
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/notificationtype/delete",
                    actions = "Xóa Loại thông báo",
                    application = "WEB ADMIN",
                    content = "Xóa Loại thông báo",
                    functions = "Danh mục",
                    is_login = false,
                    result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                    user_created = username.Value,
