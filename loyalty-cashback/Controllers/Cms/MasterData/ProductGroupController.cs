...
namespace LOYALTY.Controllers
{
    ...
    public class ProductGroupController : ControllerBase
    {
        ...
        private readonly IProductGroup _app;
        private readonly ILoggingHelpers _logging;

        private static string functions = "cms_masterdata_productgroup";
        public ProductGroupController(IConfiguration configuration, IProductGroup app, ILoggingHelpers logging)
        {
        ...
        [Route("list")]
        [HttpPost]
        public JsonResult GetList(ProductGroupRequest request)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                ...
                is_call_api = true,
                api_name = "api/productgroup/list",
                actions = "Danh sách Nhóm hàng hóa",
                application = "WEB ADMIN",
                content = "Danh sách Nhóm hàng hóa",
                functions = "Danh mục",
                is_login = false,
        ...
        public JsonResult GetDetail(Guid id)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/productgroup/" + id,
                actions = "Chi tiết Nhóm hàng hóa",
                application = "WEB ADMIN",
                content = "Chi tiết Nhóm hàng hóa",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        [Route("create")]
        [HttpPost]
        public JsonResult Create(ProductGroupRequest request)
        {
            var username = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Name)).FirstOrDefault();
            var list_permission = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Role)).Select(p => p.Value).FirstOrDefault();
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/productgroup/create",
                actions = "Tạo mới Nhóm hàng hóa",
                application = "WEB ADMIN",
                content = "Tạo mới Nhóm hàng hóa",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        [Route("update")]
        [HttpPost]
        public JsonResult Update(ProductGroupRequest request)
        {
            var username = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Name)).FirstOrDefault();
            var list_permission = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Role)).Select(p => p.Value).FirstOrDefault();
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/productgroup/update",
                actions = "Cập nhật Nhóm hàng hóa",
                application = "WEB ADMIN",
                content = "Cập nhật Nhóm hàng hóa",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        public JsonResult Delete(DeleteGuidRequest req)
        {
            ...
            if (data.code == "200")
            {
                ...
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/productgroup/delete",
                    actions = "Xóa Nhóm hàng hóa",
                    application = "WEB ADMIN",
                    content = "Xóa Nhóm hàng hóa",
                    functions = "Danh mục",
                    is_login = false,
                    result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                    user_created = username.Value,
