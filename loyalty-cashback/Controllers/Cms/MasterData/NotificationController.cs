...
namespace LOYALTY.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        private readonly INotification _app;
        private readonly ILoggingHelpers _logging;

        private static string functions = "cms_masterdata_notification";
        public NotificationController(IConfiguration configuration, INotification app, ILoggingHelpers logging)
        {
        ...
        public JsonResult GetList(NotificationRequest request)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                ...
                is_call_api = true,
                api_name = "api/notification/list",
        ...
        [Route("create")]
        [HttpPost]
        public JsonResult Create(NotificationRequest request)
        {
            var username = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Name)).FirstOrDefault();
            var list_permission = User.Claims.Where(p => p.Type.Equals(ClaimTypes.Role)).Select(p => p.Value).FirstOrDefault();
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/notification/create",
                actions = "Tạo mới Thông báo",
                application = "WEB ADMIN",
                content = "Tạo mới Thông báo",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        public JsonResult Update(NotificationRequest request)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/notification/update",
                actions = "Cập nhật Thông báo",
                application = "WEB ADMIN",
                content = "Cập nhật Thông báo",
                functions = "Danh mục",
                is_login = false,
                result_logging = data.code == "200" ? "Thành công" : "Thất bại",
                user_created = username.Value,
        ...
        public JsonResult Delete(DeleteGuidRequest req)
        {
            ...
            if (data.code == "200")
            {
                ...
                _logging.insertLogging(new LoggingRequest
                {
                    user_type = Consts.USER_TYPE_WEB_ADMIN,
                    is_call_api = true,
                    api_name = "api/notification/delete",
                    actions = "Xóa Thông báo",
                    application = "WEB ADMIN",
