...
namespace LOYALTY.Controllers
{
    ...
    public class PartnerNotificationController : ControllerBase
    {
        ...
        public PartnerNotificationController(IConfiguration configuration, IAppNotification app, ILoggingHelpers logging)
        {
        ...
        public JsonResult getListType()
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                ...
                is_call_api = true,
                api_name = "api/store/notification/listType",
        ...
        public JsonResult getList(NotificationRequest request)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_PARTNER,
                is_call_api = true,
                api_name = "api/store/notification/listNotification",
        ...
        public JsonResult getDetail(Guid id)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_PARTNER,
                is_call_api = true,
                api_name = "api/store/notification/detail/" + id,
