...
{
    [Route("api/partnerbaokimtransaction")]
    [Authorize(Policy = "WebPartnerUser")]
    [ApiController]
    public class PartnerBaoKimTransactionController : ControllerBase
    {
        ...
        public PartnerBaoKimTransactionController(IConfiguration configuration, ICommon common, ILoggingHelpers logging, LOYALTYContext context, IAdminBaoKimTransaction app, IEmailSender emailSender)
        {
        ...
        public JsonResult GetDetail(Guid id)
        {
            ...
            _logging.insertLogging(new LoggingRequest
            {
                user_type = Consts.USER_TYPE_WEB_ADMIN,
                is_call_api = true,
                api_name = "api/partnerbaokimtransaction/" + id,
