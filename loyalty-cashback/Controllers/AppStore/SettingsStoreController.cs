...
{
    [Route("api/store/StoreSettings")]
    [Authorize(Policy = "WebPartnerUser")]
    [ApiController]
    public class SettingsStoreController : ControllerBase
    {

        private readonly IConfiguration _configuration;
        private readonly ISettings _app;
        private readonly ILoggingHelpers _logging;
        public SettingsStoreController(IConfiguration configuration, ISettings app, ILoggingHelpers logging)
        {
