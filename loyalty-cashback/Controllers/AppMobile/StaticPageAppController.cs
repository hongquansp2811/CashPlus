...
{
    [Route("api/app/StaticPageApp")]
    [Authorize(Policy = "AppUser")]
    [ApiController]
    public class StaticPageAppController : ControllerBase
    {

        private readonly IConfiguration _configuration;
        private readonly IStaticPage _app;
        private readonly ILoggingHelpers _logging;
        public StaticPageAppController(IConfiguration configuration, IStaticPage app, ILoggingHelpers logging)
        {
